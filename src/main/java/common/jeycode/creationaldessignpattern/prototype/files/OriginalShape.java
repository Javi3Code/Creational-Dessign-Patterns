...
public class OriginalShape {
						...
						@Override
						public String toString() { return "OriginalShape [color=" + color + ", shape=" + shape + "]"; }

						@Override
						public int hashCode() { return Objects.hash(color,shape); }

						@Override
						public boolean equals(Object obj) {
												if (this == obj) return true;
												if (!(obj instanceof OriginalShape)) return false;
												var other = (OriginalShape)obj;
												return color == other.color && shape == other.shape;
						}

						public void setColor(JColor color) { this.color = color; }

						public void setShape(JShape shape) { this.shape = shape; }

						public JColor getColor() { return color; }

						public JShape getShape() { return shape; }

						public enum JShape {

																										SMALL(170,90), BIG(300,140);
