...
public abstract class AbstractCloud extends JLabel implements JCodeClonable {
						...
						protected AbstractCloud(OriginalShape shape) { this.shape = shape; }

						protected AbstractCloud(AbstractCloud cloud) { shape = cloud.shape; }

						@Override
						protected void paintComponent(Graphics g) {// @formatter:off
						...
						public void setOriginalShape(OriginalShape shape) { this.shape = shape; }
