...
public class GraphicsPixelFactory implements SpritesFactory {
						...
						@Override
						public Character createCharacter() { return new GPixelCharacter(); }

						@Override
						public Weapon createWeapon() { return new GPixelWeapon(); }

						@Override
						public Map createMap() { return new GPixelMap(); }

						@Override
						public Enemy createEnemy() { return new GPixelEnemie(); }
}
