...
public class Graphics2DFactory implements SpritesFactory {
						...
						@Override
						public Character createCharacter() { return new G2DCharacter(); }

						@Override
						public Weapon createWeapon() { return new G2DWeapon(); }

						@Override
						public Map createMap() { return new G2DMap(); }

						@Override
						public Enemy createEnemy() { return new G2DEnemie(); }
